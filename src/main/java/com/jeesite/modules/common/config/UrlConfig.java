...
public class UrlConfig {
     ...
     */
    public static final String URL_ADDRESS = "http://127.0.0.1:8080/selectFilePerson/selectFilePersonListAction!";

    public static final String URL_NAME = URL_ADDRESS + "req_file_number.action";

    public static final String URL_NUMBER = URL_ADDRESS + "req_file_name.action";
